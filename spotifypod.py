...
class NowPlayingFrame(tk.Frame): 
    def __init__(self, parent, controller):  
        ...
        self.frame_img = ImageTk.PhotoImage(flattenAlpha(Image.open('img/prog_frame.png')))
...
class StartPage(tk.Frame): 
    def __init__(self, parent, controller):  
        tk.Frame.__init__(self, parent) 
        self.green_arrow_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_arrow_grn.png')))
        self.black_arrow_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_arrow_blk.png')))
        self.empty_arrow_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_arrow_empty.png')))
        self.play_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_play.png')))
        self.pause_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_pause.png')))
        self.space_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_space.png')))
        self.wifi_image = ImageTk.PhotoImage(flattenAlpha(Image.open('img/pod_wifi.png')))
        self.configure(bg=SPOT_BLACK)
